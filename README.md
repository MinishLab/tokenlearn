...
Tokenlearn is a method to pre-train [Model2Vec](https://github.com/MinishLab/model2vec) static embedding models. The method is described in detail in our [Tokenlearn blogpost](https://minishlab.github.io/tokenlearn_blogpost/).
